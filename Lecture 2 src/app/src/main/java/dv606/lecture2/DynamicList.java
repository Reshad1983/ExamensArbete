	 ...
	 static final String[] COUNTRIES = new String[] {
	    ...
	    class MultiAdapter  extends ArrayAdapter<String> {
	    	...
	    	public MultiAdapter(Context context) {
	    		super(context,R.layout.multi_row, COUNTRIES);
	    	}
	    	...
	    	public View getView(int position, View convertView, ViewGroup parent) {
	    		...
	    		if (convertView == null) {	// Create new row view object   		
	    			...
	    			row = inflater.inflate(R.layout.multi_row,parent,false);
	    		}
	    		...
	    		TextView pop = (TextView)row.findViewById(R.id.population);
	    		int n = 1+rand.nextInt(150);
	    		pop.setText("Population: "+new Integer(n).toString()+" million");
